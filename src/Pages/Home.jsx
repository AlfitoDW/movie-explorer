              ...
              >
                <Link to={`/movie/${movie.id}`}>
                  ...
                  <img
                    ...
                    alt={movie.title}
                    className="rounded-lg transition-transform duration-300 group-hover:scale-105 w-full h-auto object-cover"
                  />

                  {/* Overlay title */}
                  <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white text-sm text-center opacity-0 group-hover:opacity-100 p-2 transition-opacity duration-300 rounded-b-lg">
                    {movie.title}
                  </div>
                </Link>
                ...
                <button
                  ...
                  className="absolute top-2 right-2 text-white text-lg bg-black/60 rounded-full p-1
